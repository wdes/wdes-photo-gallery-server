...
export declare class GaleryFileSystemResource {
    props: webdav.LocalPropertyManager;
    locks: webdav.LocalLockManager;
    constructor(data?: GaleryFileSystemResource);
}
export declare class GalerySerializer implements webdav.FileSystemSerializer {
    uid(): string;
...
export declare const GalerySerializerVersions: {
    versions: {
        '1.0.0': typeof GalerySerializer;
    };
    instances: webdav.FileSystemSerializer[];
};
export declare class GaleryFileSystem extends webdav.FileSystem {
    rootPath: string;
    resources: {
    ...
    protected getRealPath(path: webdav.Path): {
        realPath: string;
        resource: GaleryFileSystemResource;
    };
